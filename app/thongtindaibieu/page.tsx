  ...
  const items = [
    {
      ...
      content: "Đại hội tiến hành trong 02 ngày, từ ngày … đến ngày … tại Hội trường …",
    },
    {
      icon: <FaGavel className="text-red-600 text-4xl" />,
      title: "Nội quy, Quy chế Đại hội",
      content:
        "Đại biểu thực hiện nghiêm túc giờ giấc, trang phục, vị trí ngồi; tuân thủ hướng dẫn của Ban Tổ chức.",
    },
    {
      icon: <FaTshirt className="text-green-600 text-4xl" />,
      title: "Trang phục tại Đại hội",
      content:
        "Ngày khai mạc: Áo thanh niên Việt Nam – quần sẫm màu. Ngày làm việc còn lại: Trang phục theo hướng dẫn.",
    },
    {
